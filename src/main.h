...
static const uint256 hashGenesisBlockOfficial("0xe0d697e253772d11e1e43d2e3ac17220b37da582dd50357ba9daf3b072169bf8");
...
public:
    ...
    {
        // paccoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // paccoin: get transaction coin age
...
public:
    ...
    // paccoin: block signature - signed by coin base txout[0]'s owner
    ...
    // paccoin: two types of block: proof-of-work or proof-of-stake
    ...
    // paccoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // paccoin: calculate total coin age spent in block
    bool SignBlock(const CKeyStore& keystore);
    bool CheckBlockSignature() const;
    unsigned int GetStakeEntropyBit() const; // paccoin: entropy bit for stake modifier if chosen by modifier
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // paccoin: trust score of block chain
    int nHeight;
    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // paccoin: block index flags
    enum  
    {
