...
namespace Checkpoints
{
    ...
    // paccoin: synchronized checkpoint (centrally broadcasted)
    ...
    // paccoin: get last synchronized checkpoint
    ...
    // paccoin: only descendant of current sync-checkpoint is allowed
    ...
    // paccoin: reset synchronized checkpoint to last hardened checkpoint
...
// paccoin: sync-checkpoint master key
...
// paccoin: verify signature of sync-checkpoint message
...
// paccoin: process synchronized checkpoint
